...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):
        ...
        #self.layer4 = self._make_layer(Bottleneck2, 512, num_blocks[3], stride=2)
        
        #use this if didn't resize cifar10 (original size 32 x 32)
        #self.linear = nn.Linear(512*block.expansion, num_classes)   #(2048, 10) - (512 * 4, 10)
        
        #use this if resize cifar10 to 224 x 224
        self.linear = nn.Linear(512*block.expansion*7*7, num_classes) #(100352, 10) - (512 * 4 * 7 * 7, 10)
        
        
        #use this if resize cifar10 to 128 x 128
        #self.linear = nn.Linear(512*block.expansion*4*4, num_classes) #(100352, 10) - (512 * 4 * 4 * 4, 10)
        
        
        #use this if resize cifar10 to 64 x 64
        #self.linear = nn.Linear(512*block.expansion*2*2, num_classes) #(100352, 10) - (512 * 4 * 2 * 2, 10)
