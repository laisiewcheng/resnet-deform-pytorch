...
# this is the 2nd step in DCN process - apply the offset generated in the first steps to deformable convolution
...
class DeformConv2D(nn.Module):
    ...
    def forward(self, x, offset): #offset was generated in the first step
        ...
        # _get_p function is used to generate p, where
